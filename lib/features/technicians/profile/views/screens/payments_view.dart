...
import 'package:pyroapp/features/technicians/profile/controller/payments_controller.dart';
import 'package:pyroapp/features/technicians/profile/views/widgets/payment_methods_carousel.dart';
import '../widgets/app_scaffold.dart';

class TPaymentsView extends StatelessWidget {
  final String userId;

  const TPaymentsView({super.key, required this.userId});

  @override
  Widget build(BuildContext context) {
    return TAppScaffold(
      title: AppStrings.wallet,
      child: GetBuilder<TPaymentsController>(
        init: TPaymentsController(userId),
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    TPaymentMethodsCarousel(methods: controller.methods),
