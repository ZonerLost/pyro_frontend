...
import 'package:pyroapp/features/technicians/profile/controller/language_controller.dart';
import '../widgets/app_scaffold.dart';

class TLanguageView extends StatelessWidget {
  final String initial;

  const TLanguageView({super.key, required this.initial});
  ...
  Widget build(BuildContext context) {
    ...
    return TAppScaffold(
      ...
      child: GetBuilder<TLanguageController>(
        init: TLanguageController(initial),
