...
import 'package:pyroapp/features/owners/profile/controller/subscriptions_controller.dart';
            ...
            children: [
              Expanded(
                child: _PillOutlinedButton(
                  title: AppStrings.cancelSubscriptions,
                  onTap: onCancel,
                ),
              ),
              SizedBox(width: AppDimensions.width15),
              Expanded(
                child: _PillFilledButton(
                  title: AppStrings.renew,
                  onTap: onRenew,
                ),
              ),
            ],
