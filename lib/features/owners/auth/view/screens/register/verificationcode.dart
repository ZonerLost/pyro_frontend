...
import 'package:pyroapp/features/owners/auth/view/widgets/otp_field.dart';
...
class VerificationCode extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<OwnerAuthController>(
              ...
              RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(
                      text: controller.forgotPasswordEmailController.text,
