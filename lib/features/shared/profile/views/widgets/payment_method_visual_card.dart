...
import 'package:pyroapp/features/shared/profile/models/payment_method.dart';

class PaymentMethodVisualCard extends StatelessWidget {
  final PaymentMethod method;

  /// Keep card ratio like real credit cards (works best in PageView)
  final double aspectRatio;

  const PaymentMethodVisualCard({
    super.key,
  ...
  List<Color> get _bg {
    if (method.brand == PaymentBrand.visa) {
  ...
  String get _brandText =>
      method.brand == PaymentBrand.visa ? 'VISA' : 'MASTERCARD';
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: (h * 0.08).clamp(10.0, 16.0)),
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: (w * 0.04).clamp(8.0, 14.0)),
                            Expanded(
                              child: _labelValue(
                                label: 'Expiry date',
                                value: '02/30',
